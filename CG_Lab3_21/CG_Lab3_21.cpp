...
public:
    ...
    bool Init()
    {
        ...
        m_pTexture = new Texture(GL_TEXTURE_2D, "C:\\Users\\ASUS\\source\\repos\\CG_Lab3\\CG_Lab3_21\\Debug\\test.png");
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Chelyshkina Tutorial 21")) {
        return 1;
    }
