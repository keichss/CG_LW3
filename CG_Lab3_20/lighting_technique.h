...
struct BaseLight //все было перемещено в структуру BaseLight, которую наследуют оба типа света
{
    Vector3f Color;
...
class LightingTechnique : public Technique
{
    ...
    private:
        ...
        //Для поддержки нескольких источников света шейдер хранит массив структур аналогичных PointLight
        struct {
            GLuint Color;
            GLuint AmbientIntensity;
            GLuint DiffuseIntensity;
